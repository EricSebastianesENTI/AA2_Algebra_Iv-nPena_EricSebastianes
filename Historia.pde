...
String historiaActo0 =
 ...
 String historiaActo1 = 
  "Ante tal muestra de serenidad y valentía, Ryoma Sakamoto no pudo hacer más que escuchar a aquel hombre.\n\n" +
  "El shogunato compra barcos de guerra a los holandeses, pero ¿sabes por qué? Porque nuestros astilleros no pueden construirlos. " +
  "Hemos quedado 200 años atrás. Nuestro shogun, Iemochi Tokugawa, es un títere que firma tratados desiguales mientras los clanes se desangran entre sí.\n\n" +
  "Ryoma tiembla ante semejante noticia. Kaishu le muestra mapas: Inglaterra ya tomó Hong Kong. ¿Crees que Japón será distinto si no cambiamos?\n\n" +
  "Ryoma deja de lado su espada. En lugar de un enemigo, encontró un maestro. Y, juntos, comenzaron a trabajar juntos por derrocar al shogunato " +
  "que, aislados del mundo, los ha dejado atrás.";
  ...
  "Kaishū me dio documentos. El shōgun vende el arroz de Satsuma a cambio de opio, " +
  ...
  "En ese momento, un mercenario con fusil en mano, disparó por la espalda al aguerrido samurái.\n\n" +
  "En su último aliento no pudo hacer más que sonreír: pueden haber acabado con mi cuerpo, " +
  "pero el espíritu de mi rebelión permanecerá más vivo que nunca.\n\n" +
  "Con ello, pereció este gran héroe. Pero su lucha continuó, el shogunato cayó al año de este crimen, " +
  "dando pie a una gran era dorada para Japón. Y, el cobarde shogún Tokugawa murió enfermo y olvidado por los suyos, " +
  "mientras que el valiente Ryoma Sakamoto sigue más vivo que nunca en la memoria del pueblo japonés.";

///////////////HISTORIA INCORRECTA//////////////////////////

//Acto 1(1): 

String acto1Incorrecto = 
  "¿Quieres tomarte una taza de té?\n\n" +
  "El té contenía opio, cosa que no sabía ni Kaishu. En vez de hacerse amigos por la historia que le cuenta,\n" +
  "se hacen amiguitos tras tomarse unas copas. Cuando ya empezaban a llevarse muy bien, aparece Bowser en su helikoopa\n" +
  "y secuestra a Kaishu. Ryoma buscará venganza.";
...
+ "Ryoma cogió una de esas extrañas armas y resultó ser un caparazón azul y este sale volando y rompe la pared, parecía peligroso,\n" +
...
"Como estamos en el mundo real, la ley cuadrado angular (no pueden existir humanos de 5 metros porque caen sobre su peso) y al golpearse con el suelo se destransforma\n" +
"y por el golpe quedo gravemente herido y por culpa de eso los clanes no tienen líder por lo que no pueden unirse y el shogun buscara venganza sobre sakamoto y kaishu,\n" +
"justo cuando va a mandar la orden de ejecutarlos aparece el caparazón azul y acaba con el shogun, Kaishu ve qu ela economia se iria al pique porque las tres personas mas grandes habían caído,\n" +
"entonces coge un objeto más de la caja que les habia enseñado antes, la cual era la flor dorada la cual convierten las cosas en oro y evitan esta caída económica y Japón se convierte en la mayor potencia del mundo";
...
"y gracias a su efecto pueden derrotar al shogun bajo sus propias manos.";
