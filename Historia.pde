...
"Como estamos en el mundo real, la ley cuadrado angular (no pueden existir elefantes bípedos de 5 metros porque caerían bajo su propio peso) y al golpearse con el suelo se destransforma\n" +
"Por el golpe quedo gravemente herido y por culpa de eso los clanes no tienen líder por lo que no pueden unirse y el shogun buscara venganza sobre sakamoto y kaishu,\n" +
...
"Entonces, coge un objeto más de la caja que les habia enseñado antes, una flor dorada. La cual, convierte cualquier cosa en oro, conviendo a Japón en la mayor potencia del mundo";
